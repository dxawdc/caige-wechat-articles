"""v1.2.2 | 2026-09-15 | Markdown转微信内联HTML：语法高亮、逐行代码、紧邻图注。
用法：python 微信排版_v1.2.2.py --input 文章.md --output 输出目录
...
def main():
    ...
    for pre in doc.xpath('.//pre'):
        ...
        pre.clear();pre.set('class','code-snippet__js code-snippet_nowrap');pre.set('data-lang','text')
