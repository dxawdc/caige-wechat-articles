...
公众号文章配套资料，版本 v1.1.1，数据截至 **2026年9月24日收盘**。从东方财富30个主题板块指数的日收盘点位出发，生成“9·24”以来、2026年初以来和滚动20个交易日三种视角的赛马图。
...
资料可从[独立ZIP](../../downloads/a-share-sector-race_v1.1.1.zip)一次下载。下载HTML到本地后可直接打开交互页面；GitHub文件页可查看源码和图片。
