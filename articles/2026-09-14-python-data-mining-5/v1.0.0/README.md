...
[仅下载本篇 ZIP](https://raw.githubusercontent.com/dxawdc/caige-wechat-articles/main/downloads/python-data-mining-5_v1.0.0.zip)。解压后进入 `python-data-mining-5_v1.0.0/`，按本页运行步骤使用。
