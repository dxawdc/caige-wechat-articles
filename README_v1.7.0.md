...
<!-- 版本：v1.7.0 | 更新时间：2026-09-13 | 状态：按文章独立下载 -->

每篇文章有独立目录、独立下载包和专属运行入口。选择下表中对应文章即可下载该篇材料；仓库的 Code → Download ZIP 会下载全部文章。

| 文章 | 本篇材料 | 独立包 |
|---|---|---|
| [Python数据可视化指南：50例](articles/2026-09-13-python-visualization-50/) | 50份独立源码、模拟CSV、50张PNG与SVG、7个交互图、来源映射和241项验收 | [仅下载本篇](downloads/python-visualization-50_v1.0.0.zip) |
...
所有业务数据为教学模拟。作者：才哥AGI。历史材料保留在各目录，当前下载包以其物料清单为准。
