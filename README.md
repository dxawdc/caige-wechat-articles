...
微信公众号「可以叫我才哥」的公开配套资料：**23篇文章**。每篇提供可运行的代码、教学与模拟数据、图表和复现说明。

<!-- 版本：v1.15.0 | 更新时间：2026-09-26 | 状态：仅保留最新完整物料 -->
...
| 文章 / 当前版本 | 资料内容 | 独立下载 |
| --- | --- | --- |
| [“9·24”之后，谁跑在前面？我把30个A股主题做成了赛马图](articles/2026-09-26-a-share-sector-race/README.md) · v1.1.0 | 东方财富30主题板块日线（13,932条）、赛马图制作脚本、手机竖屏预览、两份交互HTML与文中配图 | [ZIP](downloads/a-share-sector-race_v1.1.0.zip) |
